...
export default function Teaminvite() {
    ...
    const [details, setDetails] = useState({
      ...
      multilocation:[],
      state: "",
      role: {label:"Team Member",value:"Team Member"},
    ...
    const signupDetails = async () => {
        ...
        if (emailerror) {
            ...
            let data = {
                ...
                TeamLeadEmail:profiledata.email
            ...
            await axios
                .post(`${process.env.REACT_APP_IP_ADDRESS}/karands/users/InviteTeamMember`, data)
                .then((res) => {
                    setIsLoading(false);
...
// validating email address selection................................................................................................
  ...
  return (
    <div>
        ...
        style={{}}
      >
         <label htmlFor="email" className="input-group-prepend"><p style={{fontSize:"15px"}}>Enter registered  id to invite your team member</p></label>
        ...
        <Fragment>
          ...
          <div className="mb-2" style={{ width: "100%" }}>
            <input
              ...
              type="text"
              value={profiledata.Professionalstate?profiledata.Professionalstate:""}
              aria-describedby="basic-addon1"

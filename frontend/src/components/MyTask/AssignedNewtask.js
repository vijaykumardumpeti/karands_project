...
const steps = ["mail has been sent", "form viewed", "form submited"];

export default function AssignedNewtask() {
  ...
  const renderContentBasedOnFileType = () => {
    const extension = viewimageurl
      ? viewimageurl.split(".").pop().toLowerCase()
      : "";
    ...
    try {
      ...
      if (switchtask == "education") {
        const response = await axios.post(
          ...
          }/karands/listusers/getassignededucationtasks/${localStorage.getItem(
            "id"
          )}`,
          { name: inputValue }
        );
      ...
      if (switchtask == "jobexperience") {
        const response = await axios.post(
          `${
            process.env.REACT_APP_IP_ADDRESS
          }/karands/listusers/getassignedjobtasks/${localStorage.getItem(
            "id"
          )}`,
          { name: inputValue }
        );
  ...
  async function sendalert(iuid, location) {
    ...
    const res = axios.post(
      `${process.env.REACT_APP_IP_ADDRESS}/karands/listusers/sendalert`,
      data
    );
  ...
  function setimageurlfunction(imagepath) {
    if (imagepath) {
      setviewimageurl(
        `${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${imagepath}`
      );
  ...
  const education = ["accepted", "verified"];

  const personal = ["accepted", "verified"];
  ...
  const handleEducationStatusChange = async (
    iuid,
    collegename,
    qualification,
    status
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_IP_ADDRESS}/karands/listusers/changeedustatus`,
        data
      );
      ...
      console.error(
        "An error occurred while changing education status:",
        error
      );
    }
  };
  ...
  const handleJobStatusChange = async (
    ...
    try {
      ...
      // Send the POST request to change the education status
      const response = await axios.post(
        `${process.env.REACT_APP_IP_ADDRESS}/karands/listusers/changejobstatus`,
        data
      );
  ...
  // Define a function to set the button color based on the selected status
  const getButtonColor = (selectedStatus) => {
    switch (selectedStatus) {
      ...
      case "Ongoing":
        return "blue";
      default:
        return "primary"; // Default Bootstrap button color
    }
  };
    ...
    if (profiledata._id) {
      ...
      try {
        const res = await axios.post(
          `${process.env.REACT_APP_IP_ADDRESS}/karands/listusers/addnotetoeducation`,
          data
  ...
  async function sendjobnote(iuid, companyname, experienceStart) {
    ...
    try {
      const res = await axios.post(
        `${process.env.REACT_APP_IP_ADDRESS}/karands/listusers/addnotetojob`,
        data
      ); // Provide the data object
      // Handle the response if needed
  ...
  async function handleaccepteducationtask(iuid, collegename, qualification) {
    ...
    await axios
      .post(
        `${process.env.REACT_APP_IP_ADDRESS}/karands/listusers/Accepteducationtask`,
        data
      )
  ...
  async function handleacceptjobtask(iuid, companyname, experienceStart) {
    ...
    await axios
      .post(
        `${process.env.REACT_APP_IP_ADDRESS}/karands/listusers/Acceptjobtask`,
        data
      )
          ...
          <div className={`search-bar-container ${isFocused ? "focused" : ""}`}>
            <div className="search-icon" style={{ display: "flex" }}>
              ...
              <div style={{ marginLeft: "10px" }}>
                <Button onClick={() => handleswitch("education")}>
                  EDUCATION
                </Button>

                <Button onClick={() => handleswitch("jobexperience")}>
                  JobExperience
                </Button>

                <Button onClick={() => handleswitch("companies")}>
                  Companies
                </Button>
              </div>
            </div>
            ...
            <>
              ...
              {userslist.length > 0
                ? userslist.map((data) => {
                    ...
                    if (
                      data.companydetails &&
                      data.companydetails.nameOfCompany
                    ) {
                    ...
                    return (
                      <Fragment>
                        <div
                          className="container-xl container-lg mt-4 mb-4"
                          style={{
                          ...
                          {Data.nameOfCompany && switchtask == "company" ? (
                            <div className="card">
                              ...
                              <div className="card-body ">
                                ...
                                <div className="row">
                                  <i
                                    className="bi bi-three-dots-vertical d-flex justify-content-end"
                                  ...
                                  >
                                    {Data.compnaylogo ? (
                                      ...
                                      >
                                        <img
                                          src={`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${Data.compnaylogo}`}
                                          alt="img"
                                          style={{
                                            width: "100%",
                                            height: "100%",
                                  ...
                                  <div className="col-xl-9 col-lg-9 ">
                                    <div className="row">
                                      <div className="col-lg-6 d-flex  flex-lg-row   ">
                                        <h6 className="  fs-12 fw-normal d-flex justify-content-start text-start ">
                                          {" "}
                                          Name of Company:
                                        </h6>
                                        <h6 className="text-muted pl-2 text-start">
                                          {Data.nameOfCompany
                                            ? Data.nameOfCompany
                                            : "No information"}
                                        </h6>
                                      ...
                                      <div className="col-lg-6 d-flex  flex-lg-row  ">
                                        <h6 className="  fs-12 fw-normal d-flex justify-content-start ">
                                      ...
                                      <div className="col-lg-6 d-flex  flex-lg-row  ">
                                        ...
                                        <h6 className="text-muted pl-1 d-flex">
                                ...
                                <div className="row">
                                  ...
                                  >
                                    {Data.profilepicture ? (
                                      ...
                                      >
                                        <img
                                          src={`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${Data.profilepicture}`}
                                          alt="img"
                                          style={{
                                            width: "100%",
                                            height: "100%",
                                                    ...
                                                    >
                                                      {Data.aadharCard && (
                                                        <li>
                                                          <Link
                                                            target="_blank"
                                                            to={`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${Data.aadharCard}`}
                                                          >
                                                            Adhar Card
                                                          </Link>
                                                      ...
                                                      {Data.panCard && (
                                                        <li>
                                                          <Link
                                                            target="_blank"
                                                            to={`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${Data.panCard}`}
                                                          >
                                                            panCard
                                                          </Link>
                                                          <span className="fs-4 text-success">
                                                                                    ...
                                                                                    {edu.status ===
                                                                                      ...
                                                                                      >
                                                                                        ...
                                                                                        <img
                                                                                          ...
                                                                                          src="http://cdn-icons-png.flaticon.com/512/7595/7595571.png"
                                                                                          alt="img"
                                                                                        />
                                                                                      </div>
                                                                                    )}
                                                                                    ...
                                                                                    {edu.status ===
                                                                                      ...
                                                                                      >
                                                                                        ...
                                                                                        <img
                                                                                          ...
                                                                                          src="http://cdn-icons-png.flaticon.com/512/2521/2521995.png"
                                                                                          alt="img"
                                                                                        />
                                                                                      </div>
                                                                                    )}
                                                                                                          ...
                                                                                                          <div className="message-content">
                                                                                                            <p className="message-sender">
                                                                                                              ...
                                                                                                              {conversation
                                                                                                                .senderdetails
                                                                                                                .role
                                                                                                                ? ` - ${conversation.senderdetails.role}`
                                                                                                                : ""}
                                                                                                            </p>
                                                                                    ...
                                                                                    >
                                                                                      {edu.Convocation && (
                                                                                        <li>
                                                                                          <Link
                                                                                            target="_blank"
                                                                                            to={`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${edu.Convocation}`}
                                                                                          >
                                                                                            Convocation
                                                                                          </Link>
                                                                                        </li>
                                                                                      ...
                                                                                      {edu.ConsolidatedMarksheets && (
                                                                                        <li>
                                                                                          <Link
                                                                                            target="_blank"
                                                                                            to={`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${edu.ConsolidatedMarksheets}`}
                                                                                          >
                                                                                            Consolidated
                                                                                            Marksheets
                                                                                          </Link>
                                                                                      ...
                                                                                      {edu.IndividualMarksheet && (
                                                                                        <li>
                                                                                          <Link
                                                                                            target="_blank"
                                                                                            to={`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${edu.IndividualMarksheet}`}
                                                                                          >
                                                                                            IndividualMarksheet
                                                                                          </Link>
                                                                                        </li>
                                                                                      ...
                                                                                      {edu.othersEducation && (
                                                                                        <li>
                                                                                          <Link
                                                                                            target="_blank"
                                                                                            to={`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${edu.othersEducation}`}
                                                                                          >
                                                                                            othersEducation
                                                                                          </Link>
                                                                                        </li>
 ...
 */}
                                                                                ...
                                                                                >
                                                                                  {job.OfferLetter && (
                                                                                    <li>
                                                                                      <Link
                                                                                        target="_blank"
                                                                                        to={`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${job.OfferLetter}`}
                                                                                      >
                                                                                        OfferLetter
                                                                                      </Link>
                                                                                    </li>
                                                                                  ...
                                                                                  {job.AppointmentLetter && (
                                                                                    <li>
                                                                                      <Link
                                                                                        target="_blank"
                                                                                        to={`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${job.AppointmentLetter}`}
                                                                                      >
                                                                                        Appointment
                                                                                        Letter
                                                                                      </Link>
                                                                                  ...
                                                                                  {job.AppraisalLetter && (
                                                                                    <li>
                                                                                      <Link
                                                                                        target="_blank"
                                                                                        to={`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${job.AppraisalLetter}`}
                                                                                      >
                                                                                        Appraisal
                                                                                        Letter
                                                                                      </Link>
                                                                                  ...
                                                                                  {job.SalarySlips && (
                                                                                    <li>
                                                                                      <Link
                                                                                        target="_blank"
                                                                                        to={`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${job.SalarySlips}`}
                                                                                      >
                                                                                        SalarySlips
                                                                                      </Link>
                                                                                    </li>
                                                                                  ...
                                                                                  {job.Rewards && (
                                                                                    <li>
                                                                                      <Link
                                                                                        target="_blank"
                                                                                        to={`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${job.Rewards}`}
                                                                                      >
                                                                                        Rewards
                                                                                      </Link>
                                                                                    </li>
                                                                                  )}
                                                                                  {job.othersProfessional && (
                                                                                    <li>
                                                                                      <Link
                                                                                        target="_blank"
                                                                                        to={`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost/get-private-file?key=${job.othersProfessional}`}
                                                                                      >
                                                                                        othersProfessional
                                                                                      </Link>
                                                                                    </li>
          ...
          {opensendmailform && (
            <Modal
              isOpen={openmodalforsendingmail}
              onRequestClose={closemodalforsendingmail}
              style={{
                content: {
                  width: "50%",
                  margin: "auto",
            ...
            >
              <Sendingmailform
                ...
                companymaildata={companymaildata}
              />
            </Modal>
          )}
          {/* modal for mail form..................................... */}

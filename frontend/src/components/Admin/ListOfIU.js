...
export default function ListOfIU() {
  return (
    <div>
    <Box sx={{ display: 'flex' }}>
        <AdminDashboard />
    ...
    <div className="container-sm container-sm mt-2 mb-5">
      <div className="card">
        <div className="card-header">
          <h5 className="d-flex text-start">List of Individual User</h5>
        </div>
        <div className="card-body ">
          <div className="row">
            <div className="col-lg-4 d-flex flex-column">
              ...
              <dt className="text-start"> Role : IU</dt>
            ...
            <div className="col-lg-4">
              <div>
                <div className="d-flex">
                  ...
                  <h6 className="text-muted pl-2">Madhav Rao</h6>
                </div>
                <div className="d-flex">
                  <h6 className="  fs-6 fw-normal  "> Gender :</h6>
                  <h6 className="text-muted pl-2">male</h6>
                </div>
                <div className="d-flex">
                  <h6 className="  fs-6 fw-normal "> Date of Birth :</h6>
                  <h6 className="text-muted pl-2">06-05-1996</h6>
                </div>
                <div className="d-flex">
                  <h6 className="  fs-6 fw-normal ">Marital Status :</h6>
                  <h6 className="text-muted pl-2">unarried</h6>
                </div>
                <div className=" d-flex  ">

...
const Postfeed2 = (props) => {
  ...
  async function handlePost() {
    ...
    const res = await axios.post(`${process.env.REACT_APP_IP_ADDRESS}/karands/ichpPost`, data, {
      headers: {
      ...
      <Modal isOpen={props.Show} className="postbox" >
        ...
        <div className="post-feed-content">
          ...
          <div className="post-feed-buttons">
            <button onClick={handleShowOptions} style={{ backgroundColor: "rgb(3, 104, 104)" }}>To whom do you want to show this post</button>
            <button onClick={() => handlePost()} style={{ backgroundColor: "rgb(3, 104, 104)" }}>Post</button>

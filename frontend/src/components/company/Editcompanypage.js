...
function Editcompanypage() {
  ...
  async function addCompany() {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_IP_ADDRESS}/karands/company/addcompany`, {
  ...
  async function uploadFile(file, fileName, companyId) {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_IP_ADDRESS}/karands/users/uploadcompanydetails/${localStorage.getItem('email')}/${fileName}.${fileExtension}/companydetails/${details.nameOfCompany}`,
        formData
      );
  ...
  console.log("details", details, gstdoc, registerdoc, compnaylogo)
    ...
    <div>
      ...
      <div className="row flex-nowrap" style={{ width: "100%" }}>
        ...
        <div className="col container" style={{ maxWidth: "100%" }}>
          ...
          <div>
            {/* <ICHPDashboard /> */}
            <Box component="main" sx={{ marginTop: 1, width: '80vw', display: "flex" }}>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="container-xl container-lg mt-6 mb-7">
                ...
                <div className="row d-flex justify-content-center">
                  ...
                  <div className="card col-lg-10 col-md-10">
                    ...
                    <div className="card-body" style={{height:"700px",overflow:"auto"}}>
                      <p className="text-start">Add your company details where / For whom you are working. </p>
                      <div className="row justify-content-center">
                        <div className="col-md-10 col-lg-10">
                          ...
                          <div className="mb-3 row">
                            <label
                              for="nameOfCompany"
                              className="col-sm-4 col-form-label text-start lead"
                            >
                              Name of Company:
                            </label>
                              ...
                              <div className="mb-3 row mt-4">
                                ...
                                <div className="col-sm-8">
                                  ...
                                  <input
                                    ...
                                    placeholder="GST no"
                                    onChange={(e) => {
                                      const truncatedValue = e.target.value.slice(0, 15); // Truncate to 15 characters
                              ...
                              <div className="mb-3 row">
                                ...
                                <div className="col-sm-8">
                                  <textarea
                                    ...
                                    required
                                  ></textarea>
                                  {errors.aboutCompany && <span className="errorsInreg">{errors.aboutCompany.message}</span>}
                                </div>
                            ...
                            <div className="mb-3 row">
                              ...
                              <div className="col-sm-6">
                                <input
                                  ...
                                  aria-describedby="inputGroupFileAddon04"
                                  aria-label="Upload"
                                  onChange={(event) => { setregisterdoc(event.target.files[0]) }}
                                />
                    ...
                    <div className="card-footer row justify-content-center mt-2">
                      <div className="col-md-5">
